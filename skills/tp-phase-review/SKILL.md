...
## Prerequisites
- `three-pillars-docs/tp-designs/{design-name}/plan.md` must exist with at least some tasks marked as Done.
...
6. **Write `three-pillars-docs/tp-designs/{design-name}/review.md`**:
