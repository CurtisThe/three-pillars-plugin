...
For each finding, categorize as MISSING, INCONSISTENT, ORDERING, INCOMPLETE, or MISALIGNMENT (tasks that conflict with or ignore `three-pillars-docs/vision.md`).
Limit: 400 words.
```
...
**MISALIGNMENT** — Task conflicts with or ignores `three-pillars-docs/vision.md`:
