...
- **Step 11 (commit) still runs.** Stage only the modified artifacts among `product_roadmap.md`, `architecture.md`, `known_issues.md`, `known_issues_resolved.md` — never `vision.md`. Commit message stays `Learn: {design-name} design`.
