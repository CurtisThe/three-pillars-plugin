...
## Prerequisites
- `three-pillars-docs/tp-designs/{spike-name}/design.md` must exist.
...
5. **Write `three-pillars-docs/tp-designs/{spike-name}/spike-results.md`** with this structure:
